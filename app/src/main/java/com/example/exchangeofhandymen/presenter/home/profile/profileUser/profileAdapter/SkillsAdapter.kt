...
class SkillsAdapter(private  val clickSkill:(()->Unit)?=null,private val clickClear:((Skill)->Unit)?=null) :ListAdapter<Skill, SkillViewHolder>(SkillDiffutil()){
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): SkillViewHolder {
        return SkillViewHolder(SkillItemBinding.inflate(LayoutInflater.from(parent.context),parent,false))
    }
